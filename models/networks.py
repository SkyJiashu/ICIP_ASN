...
import sys
from models.model_variants import ASNetwork
...
def define_G(input_nc, output_nc, ngf, which_model_netG, norm='batch', use_dropout=False, init_type='normal',
    ...
    if which_model_netG == 'ASN':
        assert len(input_nc) == 2
        netG = ASNetwork(input_nc, output_nc, ngf, norm_layer=norm_layer, use_dropout=use_dropout,
...
class ResnetDiscriminator(nn.Module):
    def __init__(self, input_nc, ngf=64, norm_layer=nn.InstanceNorm2d, use_dropout=False, n_blocks=6, gpu_ids=[],
