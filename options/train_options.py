...
class TrainOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--niter_decay', type=int, default=120000, help='# of iter to linearly decay learning rate to zero')
        ...
        self.parser.add_argument('--lambda_C', type=float, default=0.02, help='weight for Symmetrical L1 loss')
        # self.parser.add_argument('--lambda_D', type=float, default=0.00001, help='weight for TV loss')      
        self.parser.add_argument('--lambda_E', type=float, default=0.03, help='weight for IP loss')   
        # self.parser.add_argument('--lambda_F', type=float, default=0.6, help='weight for Local F1 loss')
        self.parser.add_argument('--lambda_G', type=float, default=1.0, help='weight for Multi-scale loss')  
        self.parser.add_argument('--lambda_GAN', type=float, default=1.0, help='weight of GAN loss')
